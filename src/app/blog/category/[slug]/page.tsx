...
const categoryTitles: { [key: string]: string } = {
  'pitch-deck-tips': 'Pitch Deck Tips',
  'guides': 'Guides',
...
const categoryDescriptions: { [key: string]: string } = {
  'pitch-deck-tips': 'Expert tips and best practices for creating compelling pitch decks that resonate with investors.',
  'guides': 'Step-by-step guides and tutorials to help you master the art of pitch deck creation.',
  'presentation-skills': 'Learn how to effectively present your pitch deck and engage with potential investors.',
  'investor-insights': 'Deep dives into investor psychology and what they look for in pitch decks.',
  'success-stories': 'Real stories from founders who successfully raised funding using our platform.',
};
...
export default function CategoryPage({ params }: { params: { slug: string } }) {
  ...
  const categoryTitle = categoryTitles[params.slug] || 'Category';
  const categoryDescription = categoryDescriptions[params.slug] || '';

  const filteredPosts = posts.filter((post) => {
    const matchesCategory = post.category === categoryTitle;
